...
public class ContactUsActivity extends AppCompatActivity {
    ...
    public void openInstructionsActivity(){
        Intent intent = new Intent(ContactUsActivity.this, InstructionsActivity.class);
    ...
    public void openAboutDeveloperActivity(){
        Intent intent = new Intent(ContactUsActivity.this, AboutDeveloperActivity.class);
        startActivity(intent);
    }
