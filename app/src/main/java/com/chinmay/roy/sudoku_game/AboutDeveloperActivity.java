...
public class AboutDeveloperActivity extends AppCompatActivity {
    ...
    public void openInstructionsActivity(){
        Intent intent = new Intent(AboutDeveloperActivity.this, InstructionsActivity.class);
        startActivity(intent);
    }

    public void openContactUsActivity(){
        Intent intent = new Intent(AboutDeveloperActivity.this, ContactUsActivity.class);
        startActivity(intent);
    }

    public void openAboutDeveloperActivity(){
        Intent intent = new Intent(AboutDeveloperActivity.this, AboutDeveloperActivity.class);
        startActivity(intent);
    }
